...
export interface ApiClassClass extends CollectionTypeSchema {
  info: {
    singularName: 'class';
    pluralName: 'classes';
    displayName: 'Class';
  ...
  attributes: {
    name: StringAttribute & RequiredAttribute;
    formTeachers: RelationAttribute<
      'api::class.class',
      'manyToMany',
      'api::teacher.teacher'
    >;
...
export interface ApiStudentStudent extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    phone: StringAttribute;
    email: EmailAttribute;
    dob: DateAttribute & RequiredAttribute;
...
export interface ApiSubjectSubject extends CollectionTypeSchema {
  info: {
...
export interface ApiTeacherTeacher extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    avatar: MediaAttribute;
    dob: DateAttribute & RequiredAttribute;
    formClasses: RelationAttribute<
      'api::teacher.teacher',
      'manyToMany',
      'api::class.class'
    >;
    subjectsThought: RelationAttribute<
      'api::teacher.teacher',
      'manyToMany',
      'api::subject.subject'
    >;
